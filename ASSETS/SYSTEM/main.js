...
function set_title(){
    ...
    else if (["af2024", "69"].includes(section)) document.getElementById("title").innerHTML += "???";
...
function load_data(){
    ...
    for (let i = 0; i < k.length; i++) if (data.save[k[i]] === undefined) data.save[k[i]] = data.constant.save[k[i]];
    if (d === null) save_data();
