...
const articles = [
    {
        ...
        content: [
            [
                ...
                `${s(8)}I will also post something on the Googology wiki. Although I see people complaining about the Fandom website, there seems to be no other place suitable to talk about googology to my knowledge. I hope this is not a bad decision.`,
