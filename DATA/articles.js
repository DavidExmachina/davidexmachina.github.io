    ...
    },
    {
        ...
        content: [
            [
                ...
                `${s(8)}We have reached the largest ordinal that the Rathjen's function based on the Mahlo Cardinal can represent and this ordinal looks pretty awkward. The Mahlo Cardinal acts like a relatively small cardinal \\( \\psi_{\\chi_{\\Gamma_{M+1}}(0)}(0) \\) (or strictly \\( sup\\{\\chi_{\\alpha}(0)|\\alpha< \\Gamma_{M+1}\\} \\)) or \\( \\Psi_{\\Xi_2}^0(\\Psi_{\\Omega_{\\Xi_2+1}}^0(3)) \\) instead of an extremely large cardinal as it's supposed to be. I think this is why Rathjen made the restriction that \\( M \\) or something larger can only be plugged into the function \\( \\alpha\\rightarrow\\omega^\\alpha \\) instead of the whole Veblen function.`,
